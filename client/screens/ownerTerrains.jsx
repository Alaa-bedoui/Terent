...
const HandleOwnerTerrains = ({ navigation, route }) => {
  ...
  //       `${baseUrl}api/terrain/owner/${route.params.id}`
  //     );
  //     console.log("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", ownerTerrains);
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/terrain/owner/dFaAF4CSP1Rmkb04vSdgiDGR9Kq1`)
      .then((res) => setTerrains(res.data));
  }, []);
  const showToast = () => {
    ToastAndroid.show(
      "Redirecting to map to choose your location !",
